...
I started from art as an example, because I work in an artistic environment.
But NFTs as I showed you with other examples are a way to collect digital assets.
This brings together a lot of things that have potential for collection, historical moment, Tweet, real estate etc... and many more uses are to come.

Obviously there are still some problematic points: Today one of the biggest barriers to its adoption is the technology on which NFTs are built: the blockchain. The user experience or UX of the entire domain is still in development, difficult for people who don't understand the domain to assimilate all of the terms.
A lot of work remains on creating a simplified experience for buying, selling, and collecting all assets.

Just as we have succeeded in simplifying the purchase journey on the internet, that of NFTs is still under construction to allow easier adoption by people with no knowledge.
There aren't exactly easy ways to display all of the physical token arts we've collected, but that will come. Even though <a href="https://www.youtube.com/watch?v=PSm1rdd1ywc" className="underline">Beeple</a> showed us the potential with the installation he pointed out and sent to each holder of the works purchased. Other things to know, in France capital gains of more than €500 are taxed at 30%. Exchanges are like banks, we have to report them at income tax time.
And finally, transaction fees are sometimes very expensive at the time of this writing.

The law today is very vague for the tax administration concerning NFTs in themselves.
I leave you to do some research to learn more about the specific taxation of NFTs.

Good exploration on the subject, I would be delighted to discuss with you about NFT on my social networks.
